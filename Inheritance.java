public class Inheritance 
{
	public static void main(String[] args) {
		Student student1 = new Student("Maricar", " Brgy. Camastilisan Calaca, Batangas", "BSIT", 2);
        ...
        System.out.println();
		Staff staff1 = new Staff("Eliza", "Camastilisan Calaca, Batangas", "Batangas State University", 500.00f );
